...
public class IrcMessageCreator {
  ...
  static {
    messageSchema = SchemaBuilder.struct()
        ...
        .field("CreatedAt", Timestamp.builder().doc("When this message was received.").required().build())
  ...
  public static void create(Date createdAt, String channel, String sender, String login, String hostname, String message, Struct struct) {
    struct
